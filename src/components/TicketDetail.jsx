    ...
    <div className="detail-wrap">
      ...
      <div className="detail-header">
        ...
        <div className="detail-badges">
          <Badge label={TYPE_LABELS[ticket.type] ?? ticket.type} scheme={{ background: '#f1f5f9', color: '#4b5563' }} />
          <Badge label={STATUS_LABELS[ticket.status] ?? ticket.status} scheme={STATUS_SCHEME[ticket.status]} />
          <Badge label={PRIORITY_LABELS[ticket.priority] ?? ticket.priority} scheme={PRIORITY_SCHEME[ticket.priority]} />
        </div>
      </div>
